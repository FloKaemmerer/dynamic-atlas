            ...
            <v-card>
                <v-card-text>
                    <v-row>
                        <v-col>
                            <v-row>
                                <v-col cols="3">Openness:</v-col>
                                <v-col>The Openness of a Map describes how narrow the Layout is. The higher the Value
                                    the more
                                    open it is. <br>
                                    eg:<br>
                            ...
                            <v-row>
                                <v-col cols="3">Traversability:</v-col>
                                <v-col>The Traversability describes how "easy" it is to travers the map <br>
                            ...
                            <v-row>
                                <v-col cols="3">Backtrack Factor:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="3">Linearity:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="3">Terrain Slots:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="3">Rushable Boss:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="3">Phased Boss:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="3">Skippable Phases:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="3">Spawn Intro Phase:</v-col>
                                <v-col>tbd
                                </v-col>
                            </v-row>
                        </v-col>
                        ...
                        <v-col>
                            <v-row>
                                <v-col cols="3">Drop Weight:</v-col>
                                <v-col>Every Item in Path of Exile has a certain weighting associated with it.<br>
                            ...
                            <v-row>
                                <v-col cols="3">Base Drop Chance:</v-col>
                                <v-col>The Base Drop Chance of a Divination Card is the Chance, that IF a card is
                                    dropped
                            ...
                            <v-row>
                                <v-col cols="3">Effective Value:</v-col>
                                <v-col>The Effective Value of a Card is determined by:<br>
